package com.inovisec.caloriestracker.domain.usecase.analytics

import com.inovisec.caloriestracker.domain.model.DayMacros
import com.inovisec.caloriestracker.domain.repository.DiaryRepository
import java.time.LocalDate
import javax.inject.Inject

class GetWeeklyMacroTrendsUseCase @Inject constructor(private val repository: DiaryRepository) {
